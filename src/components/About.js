            ...
            <div className="accordion" id="accordionExample">
                ...
                <div className="accordion-item" style={{ color: props.textColor, backgroundColor: 'transparent' }}>
                    <h2 className="accordion-header" >
                        <button className="accordion-button" style={{ backgroundColor: "transparent", color: props.textColor, border: props.buttonBorder }} type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                ...
                <div className="accordion-item" style={{ color: props.textColor, backgroundColor: 'transparent' }}>
                    <h2 className="accordion-header">
                        <button style={{ backgroundColor: "transparent", color: props.textColor, border: props.buttonBorder }} className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
